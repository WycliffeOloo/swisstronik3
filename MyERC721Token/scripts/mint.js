...
async function main() {
    const replace_contractAddress = "0x98358BFf1F7A2F46daE3D96D083c87902BD54987";
    const [from] = await hre.web3.eth.getAccounts();
    const contractFactory = await hre.ethers.getContractFactory("OSIEPNANFT");
    ...
    const replace_functionArgs = "0x573E07B6F63eEAb2087399c34764D3Bb26EdB8f4"; // Recipient address
